...
if __name__ == '__main__':
    ...
    descrip = 'Apr19_timm_vit_augmented'
    debug = True
    ...
    # get model from timm
    model = timm.create_model('gluon_resnet34_v1b', pretrained=True,num_classes=2)
    ...
    train_transform = transforms.Compose([
        ...
        transforms.RandomResizedCrop(size=(224, 224),scale=(0.7,1.1),ratio=(0.7,1.1)),
    ...
    for epoch in range(Epoch,Epoch+epoch_len):
        ...
        for param_group in optimizer.param_groups:
            print('lr of {} is {}'.format(epoch,param_group['lr']))
        ...
        with torch.no_grad():
            for j, (inputs_val, labels_val) in enumerate(val_loader):
                targets_val = labels_val.long().cuda()
        ...
        if epoch >10 and bst_acc <= accuracies_val.avg :
        ...
        print('best model found at epoch {} with val_loss {} and val_acc {}'.format(better_epoch,bst_loss,bst_acc))
